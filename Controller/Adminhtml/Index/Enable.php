    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                $name  = $model->getName();
                $model->setIsActive(Status::ENABLED);
                $this->_repository->save($model);
                $this->messageManager->addSuccessMessage(__('The distribution has been enabled.'));
                $this->_eventManager->dispatch(
                    'adminhtml_distribution_on_enable',
                    [
                        'title'  => $name,
                        'status' => 'success',
                    ]
        ...
        $this->messageManager->addErrorMessage(__('We can\'t find a distribution to enable.'));
